...
public class SceneNode extends DefaultMutableTreeNode {
	...
	protected Object convertVector3ToIntList(Vector3f v)
	{
	...
	public static SceneNode fromYamlObject(GL2 gl, Object yamlObject)
	{
		...
		else if (yamlMap.get("type").equals("SceneNodeKeyframeable"))
			return SceneNodeKeyframeable.fromYamlObject(gl, yamlObject);
		else if (yamlMap.get("type").equals("MeshNodeKeyframeable"))
			return MeshNodeKeyframeable.fromYamlObject(gl, yamlObject);
		else if (yamlMap.get("type").equals("LightNodeKeyframeable"))
			return LightNodeKeyframeable.fromYamlObject(gl, yamlObject);
	//	else if (yamlMap.get("type").equals("ParticleSystemNode"))
	//		return ParticleSystemNode.fromYamlObject(gl, yamlObject);
		else
